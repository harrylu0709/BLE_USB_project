...
AHB prescalar = 1
APB prescalar1 = 4, APB prescalar2 = 2
MCO1 prescalar = 2
...
void configure_clock()
{
    ...
    MODIFY_REG(FLASH->ACR, 
        FLASH_ACR_LATENCY, 
        _VAL2FLD(FLASH_ACR_LATENCY, FLASH_ACR_LATENCY_5WS)
    ...
    MODIFY_REG(RCC->PLLCFGR, 
        (RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLQ | RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLP), 
        (_VAL2FLD(RCC_PLLCFGR_PLLM, 4) | _VAL2FLD(RCC_PLLCFGR_PLLN, 168) |_VAL2FLD(RCC_PLLCFGR_PLLQ, 7) | RCC_PLLCFGR_PLLSRC_HSE)
    );
#endif
    /*
    PLL: M=4, N=168, P=2,Q=7
    ...
    */
    ...
    MODIFY_REG(RCC->CFGR, 
        RCC_CFGR_PPRE1, 
        _VAL2FLD(RCC_CFGR_PPRE1, 5)
    );
    MODIFY_REG(RCC->CFGR, 
        RCC_CFGR_PPRE2, 
        _VAL2FLD(RCC_CFGR_PPRE2, 4)
    );
#else
