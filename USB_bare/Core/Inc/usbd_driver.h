...
#define USB_OTG_FS_WAKEUP_EXTI_ENABLE_IT()    EXTI_->IMR |= USB_OTG_FS_WAKEUP_EXTI_LINE
#define USB_OTG_FS_WAKEUP_EXTI_DISABLE_IT()   EXTI_->IMR &= ~(USB_OTG_FS_WAKEUP_EXTI_LINE)
#define USB_OTG_FS_WAKEUP_EXTI_GET_FLAG()     EXTI_->PR & (USB_OTG_FS_WAKEUP_EXTI_LINE)
#define USB_OTG_FS_WAKEUP_EXTI_CLEAR_FLAG()   EXTI_->PR = USB_OTG_FS_WAKEUP_EXTI_LINE

#define USB_OTG_FS_WAKEUP_EXTI_ENABLE_RISING_EDGE() \
  do { \
    EXTI_->FTSR &= ~(USB_OTG_FS_WAKEUP_EXTI_LINE); \
    EXTI_->RTSR |= USB_OTG_FS_WAKEUP_EXTI_LINE; \
  } while(0U)
